...
public class JhipsterApplicationUneApp {

    private static final Logger log = LoggerFactory.getLogger(JhipsterApplicationUneApp.class);

    private final Environment env;

    public JhipsterApplicationUneApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes jhipsterApplicationUne.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JhipsterApplicationUneApp.class);
